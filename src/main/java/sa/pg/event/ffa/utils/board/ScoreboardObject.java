 ...
 * <p>
 * The project is on <a href="https://github.com/MrMicky-FR/ScoreboardObject">GitHub</a>.
 *
 * @author MrMicky
 * @version 1.2.0
 */
public class ScoreboardObject {
    ...
    /**
     * Creates a new ScoreboardObject.
     *
     ...
     *
     * @return current player for this ScoreboardObject
     */
    ...
    /**
     * Delete this ScoreboardObject, and will remove the scoreboard for the associated player if he is online.
    ...
    private void sendPacket(Object packet) throws Throwable {
        if (this.deleted) {
            throw new IllegalStateException("This ScoreboardObject is deleted");
        }
